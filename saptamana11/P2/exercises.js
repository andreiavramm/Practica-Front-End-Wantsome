...
const removedInactive = myData.filter(status => status.active === true);
...
const idReturn = movieLists.filter(() => {
    return movieLists.videos.id
})
